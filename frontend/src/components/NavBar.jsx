...
export const Navbar = () => {
  ...
  const data = useMemo(() => [
    { link: '/user', label: t('navbar.profile'), icon: IconUserCircle, select: 'profile' },
    { link: '/user', label: t('navbar.history'), icon: IconHistory, select: 'history' },
    { link: '/user', label: t('navbar.addresses'), icon: IconTruckDelivery, select: 'addresses' },
    { link: '/user', label: t('navbar.discounts'), icon: IconRosetteDiscount, select: 'discounts' },
    { link: '/user', label: t('navbar.help'), icon: IconHelp, select: 'help' },
  ], [t])
